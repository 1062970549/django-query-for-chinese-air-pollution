...
queue()
    .defer(d3.json, "/static/data/map/china_cities.json")
    .defer(d3.json, "/static/data/map/china_provinces.json")
    .defer(d3.csv, "/static/data/map/china_cities.csv", function(d) {rateById.set(d.id, +d.value);})
    .await(makeMap);
